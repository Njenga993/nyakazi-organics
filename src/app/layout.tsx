...
export const metadata: Metadata = {
  ...
  description:
    "Discover the nutritional power of indigenous African vegetables. Sustainably grown using traditional agroecological methods. Fresh, organic products straight from Kenyan farms to your table.",
  keywords: [
...
const jsonLd = {
  ...
  description:
    "Fresh, organic indigenous African vegetables grown using sustainable agroecological methods.",
  contactPoint: {
    "@type": "ContactPoint",
